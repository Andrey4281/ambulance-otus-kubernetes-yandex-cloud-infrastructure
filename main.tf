module "yc-vpc" {
  source              = "git@github.com:terraform-yc-modules/terraform-yc-vpc.git?ref=master"
...
module "kube" {
  source     = "git@github.com:terraform-yc-modules/terraform-yc-kubernetes.git?ref=master"
